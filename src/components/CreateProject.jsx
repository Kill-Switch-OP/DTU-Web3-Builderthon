...
const CreateProject = () => {
  ...
  return (
    ...
    >
      <div
        className="custom-bg-color shadow-black
      ...
      >
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex justify-center items-center mt-5">
            <div className="rounded-xl overflow-hidden h-20 w-20">
              <img
                src={
                  imageURL ||
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKXSCPook-YriCdrxhxOCLxLI0TgipAozFnQ&usqp=CAU'
                }
                alt="project title"
          ...
          <div
            className="flex justify-between items-center bg-white rounded-xl mt-5"
